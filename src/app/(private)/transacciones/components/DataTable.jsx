        ...
        <>
            ...
            {    
                Array.isArray(transactionsAll) && transactionsAll.length === 0 && 
                    <Typography sx={{textAlign: 'center', marginTop: '20px'}}>No existe listado de transacciones, dirígete a la sección de LINK y hacer click en Ver Transacciones </Typography>
            }
        </>
    )
}